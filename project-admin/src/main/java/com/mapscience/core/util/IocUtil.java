 ...
 * 
 *说明：
 *<p>  内部Bean实例所在ApplicationContext的封装类,
 *    提供静态方法getBean, 可以获得所有定义的 ApplicationContext 内部所有Bean的实例.</p>
 * 书写者 @author  WCF
 * 创建时间 2019年2月22日
 *
 */
...
public class IocUtil implements ApplicationContextAware {
     ...
     * 日志记录器.
     */
    protected static final Logger logger = LogHandler.getLogger("common.utils");
