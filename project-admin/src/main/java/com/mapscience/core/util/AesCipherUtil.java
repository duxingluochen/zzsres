...
public class AesCipherUtil {
    ...
    public static String enCrypto(String str) {
        try {
            ...
            throw new ProjectException(500, "getInstance()方法异常:" + e.getMessage());
        } catch (UnsupportedEncodingException e) {
            LOGGER.error("Bsae64加密异常:" + e.getMessage());
            throw new ProjectException(500, "Bsae64加密异常:" + e.getMessage());
        } catch (NoSuchPaddingException e) {
            LOGGER.error("getInstance()方法异常:" + e.getMessage());
            throw new ProjectException(500, "getInstance()方法异常:" + e.getMessage());
        } catch (InvalidKeyException e) {
            LOGGER.error("初始化Cipher对象异常:" + e.getMessage());
            throw new ProjectException(500, "初始化Cipher对象异常:" + e.getMessage());
        } catch (IllegalBlockSizeException e) {
            LOGGER.error("加密异常，密钥有误:" + e.getMessage());
            throw new ProjectException(500, "加密异常，密钥有误:" + e.getMessage());
    ...
    public static String deCrypto(String str) {
        try {
            ...
            throw new ProjectException(500, "解密异常，密钥有误:" + e.getMessage());
        } catch (BadPaddingException e) {
            LOGGER.error("解密异常，密钥有误:" + e.getMessage());
            throw new ProjectException(500, "解密异常，密钥有误:" + e.getMessage());
        }
