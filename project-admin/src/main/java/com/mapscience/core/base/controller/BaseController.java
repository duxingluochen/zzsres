...
public class BaseController {
     ...
     * 生成统一的返回响应对象（带返回数据）
     *
     * @param projectStatusEnum 状态枚举
     * @param data              返回数据
     * @param <T>               返回数据类型
     * @return
     */
    public <T> ResponseVal responseBody(ProjectStatusEnum projectStatusEnum, T data) {
        return new ResponseVal(projectStatusEnum.getCode(), projectStatusEnum.getMsg(), data);
    }
     ...
     * @return
     */
    public <T> ResponseVal responseBody(ProjectStatusEnum projectStatusEnum) {
        return new ResponseVal(projectStatusEnum.getCode(), projectStatusEnum.getMsg());
    }
