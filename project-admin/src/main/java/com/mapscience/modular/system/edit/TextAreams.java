...
public class TextAreams extends Text {
	...
	public static TextAreams parseText(String text) {
		TextAreams t = CommonUtils.parseInputAttrsT(text , TextAreams.class);
