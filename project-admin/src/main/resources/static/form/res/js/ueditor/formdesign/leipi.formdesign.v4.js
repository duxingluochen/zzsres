 ...
 * ```
 */
UE.plugins['textuper'] = function () {
	var me = this,thePlugins = 'textuper';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/textuper.html',
				name:thePlugins,
				editor:this,
				title: '大写文本框',
				cssRules:"width:600px;height:310px;",
	...
	me.addListener( 'mouseover', function( t, evt ) {
		...
		if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
			var html = popup.formatHtml(
				'<nobr>大写文本框: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
			if ( html ) {
				popup.getDom( 'content' ).innerHTML = html;
				popup.anchorEl = el;
				popup.showAnchor( popup.anchorEl );
...
//关联表单文本框
UE.plugins['relation'] = function () {
	var me = this,thePlugins = 'relation';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/relation.html',
				name:thePlugins,
				editor:this,
				title: '关联表单文本框',
				cssRules:"width:600px;height:310px;",
...
UE.plugins['textareams'] = function () {
    var me = this,thePlugins = 'textareams';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/textareams.html',
                name:thePlugins,
                editor:this,
                title: '多行关联文本框',
    ...
    me.addListener( 'mouseover', function( t, evt ) {
		...
		if ( /textarea/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>多行关联文本框: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
...
//公司插件
UE.plugins['comname'] = function () {
	var me = this,thePlugins = 'comname';
	me.commands[thePlugins] = {
		execCommand:function () {
			var dialog = new UE.ui.Dialog({
				iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/comname.html',
				name:thePlugins,
				editor:this,
				title: '用户框',
				cssRules:"width:600px;height:310px;",
...
//基本插件
UE.plugins['basicform'] = function () {
    var me = this,thePlugins = 'basicform';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/basicform.html',
                name:thePlugins,
                editor:this,
                title: '表单模板',
    ...
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                ...
                editor:this,
                title: '单选框组',
                cssRules:"width:620px;height:370px;",
                buttons:[
                {
                    className:'edui-okbutton',
                    label:'确定',
...
UE.plugins['textarea'] = function () {
    ...
    me.addListener( 'mouseover', function( t, evt ) {
    	evt = evt || window.event;
        var el = evt.target || evt.srcElement; 
        var plugins_type =  el.getAttribute('leipiplugins')
        if ( /textarea/ig.test( el.tagName ) && plugins_type == thePlugins) {
            var html = popup.formatHtml(
 ...
 * @example
 * ```javascript
 * editor.execCommand( 'datepicker');
 * ```
 */
UE.plugins['datepicker'] = function () {
    var me = this,thePlugins = 'datepicker';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/datepicker.html',
                name:thePlugins,
                editor:this,
                title: '日期选择框',
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        var el = evt.target || evt.srcElement; 
        var plugins_type =  el.getAttribute('leipiplugins')
        if ( /input/ig.test( el.tagName ) && plugins_type == thePlugins) {
            var html = popup.formatHtml(
                '<nobr>日期选择框: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
 ...
 * ```
 */
UE.plugins['achievement-listctrl-up'] = function () {
    var me = this,thePlugins = 'achievement-listctrl-up';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/achievement-listctrl-up.html',
                name:thePlugins,
                editor:this,
                title: '上月绩效列表控件',
                cssRules:"width:800px;height:400px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>上月绩效列表控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
 ...
 * ```
 */
UE.plugins['achievement-listctrl-this'] = function () {
    var me = this,thePlugins = 'achievement-listctrl-this';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/achievement-listctrl-this.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
                cssRules:"width:800px;height:400px;",
    ...
    me.addListener( 'mouseover', function( t, evt ) {
        ...
        if ( /input/ig.test( el.tagName ) && leipiPlugins==thePlugins) {
            var html = popup.formatHtml(
                '<nobr>本月绩效计划列表控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>' );
            if ( html ) {
                popup.getDom( 'content' ).innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor( popup.anchorEl );
 ...
 * ```
 */
UE.plugins['listctrls'] = function () {
    var me = this,thePlugins = 'listctrls';
    me.commands[thePlugins] = {
        execCommand:function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl:this.options.UEDITOR_HOME_URL + UE.leipiFormDesignUrl+'/listctrls.html',
                name:thePlugins,
                editor:this,
                title: '列表控件',
                cssRules:"width:800px;height:400px;",
